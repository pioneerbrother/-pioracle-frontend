...
export function WalletProvider({ children }) {
    ...
    const setupState = useCallback(async (provider, chainId, signer = null, address = null) => {
        ...
        setConnectionState({
            provider: provider, // Set provider here
            signer: signer, 
